...
- 📦 **开箱即用** - 安装即用，无需复杂配置
- 🧪 **测试完备** - 133 个测试用例 100% 通过（含 Hooks 实时捕获测试）
...
- [🧪 测试报告](tests/TEST-REPORT.md) - 133 测试用例 100% 通过
...
详细的 Windows 安装指南（WSL2 / Git Bash）见 **[兼容性指南](docs/COMPATIBILITY.md#windows-用户指南)**。
